...
| <a name="input_applications"></a> [applications](#input\_applications) | List of ArgoCD applications to be applied after the cluster is created | <pre>list(object({<br/>    name      = string<br/>    project   = string<br/>    repo_url  = string<br/>    revision  = string<br/>    path      = string<br/>    server    = string<br/>    namespace = string<br/>  }))</pre> | `[]` | no |
...
| Name | Type |
|------|------|
| [argocd_application.applications](https://registry.terraform.io/providers/argoproj-labs/argocd/7.15.0/docs/resources/application) | resource |
