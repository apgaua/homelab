...
| <a name="input_iso"></a> [iso](#input\_iso) | ISO image configuration | <pre>object({<br/>    url                   = string<br/>    file_name             = string<br/>    talos_installer_image = string<br/>    version               = string<br/>    checksum              = string<br/>    checksum_algorithm    = string<br/>  })</pre> | n/a | yes |
