...
| <a name="input_bootstrap_manifests_path"></a> [bootstrap\_manifests\_path](#input\_bootstrap\_manifests\_path) | Path to the bootstrap app manifest | `string` | `""` | no |
| <a name="input_bootstrap_manifests_repo"></a> [bootstrap\_manifests\_repo](#input\_bootstrap\_manifests\_repo) | URL of the bootstrap manifests repository | `string` | `""` | no |
...
| Name | Type |
|------|------|
| [argocd_application.bootstrap](https://registry.terraform.io/providers/argoproj-labs/argocd/7.15.0/docs/resources/application) | resource |
